<template>
    <div style="background-color: white;text-align: center;">
      ...
      <div style="margin-top: 30px">
        ...
        <el-input v-model="form.password" style="width: 300px; margin-top: 10px;" type="password" placeholder="密码">
          <template #prefix>
        ...
        <div style="margin-top: 20px">
          <el-button style="width: 150px" type="Primary" @click="">注册账号</el-button>
        </div>
      </div>
    </div>
</template>
